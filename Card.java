...
public class Card implements Comparable<Card> {
    ...
    // Cache for created cards so that we don't create the same identical cards over and over again.
    ...
    public static Card from(String s) {
        ...
        if(rank < 0 || suit < 0 || rank > 12 || suit > 3) {
            throw new IllegalArgumentException("String " + s + " is not a proper card");
        }
        if(cards[suit][rank] == null) { cards[suit][rank] = new Card(suit, rank); }
