...
public class PLBadugiRunner {
    ...
    private static final int SAMPLE_OUTPUT= -1;
    ...
    // Seed for the RNG that organizes the tournament.
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i = 0; i < playerClasses.length - 1; i++) {
            int j = rng.nextInt(playerClasses.length - i) + i;
            String tmp = playerClasses[i];
            playerClasses[i] = playerClasses[j];
            playerClasses[j] = tmp;
        }
